...
fileVersion="20230816"  #for two columns Species_identification.txt
...
#sys.exit()
column_name=['Barcode','Species name']
...
df_species=pd.read_csv(f'{args.inputDirectory}/Species_identification.txt',names=['barcode','species'],sep='\t')
